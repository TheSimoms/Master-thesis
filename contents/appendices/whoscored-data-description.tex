\chapter{\whoscoredplain\ data description}
...
\begin{table}[H]
    ...
    \noindent\begin{tabulary}{\textwidth}{| L | L | L | L |}
        ...
        Type                & What type of event it is (\refertable{tab:whoscored-event-types}) & \xmark \\\hline
...
\begin{table}[H]
    ...
    \noindent\begin{tabular}{| p{3cm} | p{10cm} |}
        ...
        PlayerStatistics & Height, weight, matches played, minutes played, ratings, and numbers from \refertable{tab:whoscored-player-metrics} for the players in the competing teams' squads. \\\hline
...
\begin{table}[H]
    ...
    \noindent\begin{tabular}{| p{3cm} | p{10cm} |}
        \hline
        \textbf{URL post-fix} & \textbf{Description} \\\hline
        Show & List of recent matches. List of coming matches. Current squad, with summary of the numbers from \refertable{tab:whoscored-player-metrics} for each player. Team characteristics. Top players. Formation summary (seasonal, last match, and a list of what positions the current squad members have played). \\\hline
        ...
        History & List of team squads, with summary of the numbers from \refertable{tab:whoscored-player-metrics} for each player. Option show statistics from different seasons. \\\hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \noindent\begin{tabular}{| p{3cm} | p{10cm} |}
        \hline
        \textbf{URL post-fix} & \textbf{Description} \\\hline
        Show & Player information (name, height, weight, full name, age, nationality, current team, shirt number, positions). Tournaments the player currently participates in, with summary of the numbers from \refertable{tab:whoscored-player-metrics}. List of different playing positions the player has had. Player characteristics. List of the last 10 matches the player participated in. \\\hline
        Fixtures & List of matches the current season where the player has participated. \\\hline
        History & Summary of the player's career, including competitions, matches played, minutes played, and the numbers from \refertable{tab:whoscored-player-metrics} \\\hline
    \end{tabular}
